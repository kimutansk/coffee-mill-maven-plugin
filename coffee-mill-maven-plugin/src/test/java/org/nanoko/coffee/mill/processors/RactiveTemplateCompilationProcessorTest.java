...
public class RactiveTemplateCompilationProcessorTest {

    @Test
    public void testRactiveCompilation() throws MojoExecutionException, MojoFailureException {
        JavaScriptCompilerMojo mojo = new JavaScriptCompilerMojo();
        mojo.javaScriptDir = new File("src/test/resources/js");
        mojo.workDir = new File("target/test/testRactiveCompilation-www");
        mojo.execute();
        File result = new File(mojo.workDir, "sample/templates/rktemplate.js");
